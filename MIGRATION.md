...
Open your `pubspec.yaml` file and align dependencies.
...
-  notificare_in_app_messaging: ^4.0.0
-  notificare_inbox: ^4.0.0
-  notificare_loyalty: ^4.0.0
-  notificare_push: ^4.0.0
-  notificare_push_ui: ^4.0.0
-  notificare_user_inbox: ^4.0.0

+  actito: ^5.0.0
+  actito_assets: ^5.0.0
+  actito_geo: ^5.0.0
+  actito_in_app_messaging: ^5.0.0
+  actito_inbox: ^5.0.0
+  actito_loyalty: ^5.0.0
+  actito_push: ^5.0.0
+  actito_push_ui: ^5.0.0
...
Align the dependency inside your Notifications Service Extension target in `Podfile`:

```diff
target 'NotificationServiceExtension' do
   use_frameworks!

-  pod 'Notificare/NotificareNotificationServiceExtensionKit', '4.x.x'
+  pod 'Actito/ActitoNotificationServiceExtensionKit', '5.x.x'
end
```
...
Similarly, update all imports from the `import 'package:notificare*/notificare*.dart'` to `import 'package:actito*/actito*.dart'`.
...
- void _presentNotification(NotificareInboxItem item) async {
+ void _presentNotification(ActitoInboxItem item) async {
  try {
