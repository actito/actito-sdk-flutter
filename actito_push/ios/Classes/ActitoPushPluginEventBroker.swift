//
//  ActitoPushPluginEventBroker.swift
//  actito_push
//
...
// ActitoPushPluginEventBroker.Stream
extension ActitoPushPluginEventBroker {
...
// ActitoPushPluginEventBroker.Event
extension ActitoPushPluginEventBroker {
...
extension ActitoPushPluginEventBroker {
    static func OnNotificationReceived(notification: ActitoNotification, deliveryMechanism: ActitoNotificationDeliveryMechanism) -> Event {
        return Event(
    ...
    static func OnSubscriptionChanged(subscription: ActitoPushSubscription?) -> Event {
        return Event(
