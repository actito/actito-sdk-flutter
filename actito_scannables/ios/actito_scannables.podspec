...
Pod::Spec.new do |s|
  ...
  s.summary          = 'Actito Scannables Flutter Plugin'
  s.description      = <<-DESC
...
For support please use: http://support.notifica.re
  ...
  s.source           = { :path => '.' }
  s.source_files = 'actito_scannables/Sources/actito_scannables/**/*'
  s.dependency 'Flutter'
  s.dependency 'Actito/ActitoKit', actito_version
  s.dependency 'Actito/ActitoScannablesKit', actito_version
  s.platform = :ios, '13.0'
  s.swift_version = '5.0'
end
