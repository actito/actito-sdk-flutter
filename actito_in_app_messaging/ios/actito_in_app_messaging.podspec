...
actito_version = '5.0.0-canary.4'

Pod::Spec.new do |s|
  s.name             = pubspec['name']
  s.version          = pubspec['version']
  s.summary          = 'Actito In-App Messaging Flutter Plugin'
  s.description      = <<-DESC
...
For support please use: http://support.notifica.re
  ...
  s.source           = { :path => '.' }
  s.source_files = 'actito_in_app_messaging/Sources/actito_in_app_messaging/**/*'
  s.dependency 'Flutter'
  s.dependency 'Actito/ActitoKit', actito_version
  s.dependency 'Actito/ActitoInAppMessagingKit', actito_version
  s.platform = :ios, '13.0'
  s.swift_version = '5.0'
end
